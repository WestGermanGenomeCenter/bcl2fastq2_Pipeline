...
if $local ; then
    ...
    cp envs/local/* envs/
    snakemake $snakemake_params -s rules/convert2fastq.smk --conda-frontend mamba --use-conda -p --keep-going
